...
int rowNumber=0;                          /* Initializing the row number, seconds in which the excel file records the data
...
{   
  ...
  delay(1000);  //small delay so that the number doesn't change too quickly to read
